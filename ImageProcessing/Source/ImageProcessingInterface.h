...
{
public:
	virtual  void ThresholdMethod(const frame& Input, frame& Output, const uint8_t ThresholdValue) = 0;
	...
	virtual void Otsu(const frame& Input, frame& Output, uint8_t& ThresholdValue) = 0;
